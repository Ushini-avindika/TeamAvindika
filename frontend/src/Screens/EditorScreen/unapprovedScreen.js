...
import { unappConList, deleteConDetails } from '../../action/conferenceAction'
...
import { mainListItems, secondaryListItems } from './Editor dashboard/listitems1';
...
const unappconlistScreen = () => {
      ...
      const unappCon = useSelector((state) => state.unappCon)
                  ...
                  <div className={classes.root}>
                        ...
                        <main className={classes.content}>
                              ...
                              <Container maxWidth="lg" className={classes.container}>
                                    <h1>All Unapproved Conference Details</h1>
...
export default unappconlistScreen